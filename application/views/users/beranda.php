...
<div class="page-inner">
  ...
  <div class="alert alert-info mb-4">
    ...
    <?php if ($level != 'admin') { ?>
      <small> Selamat Datang <b class="text-warning"> <?php echo ucwords($nama); ?></b> di Sistem Informasi Administrasi Surat! Anda login sebagai <span class="badge badge-success fw-bold"><i class="fas fa-id-badge"></i>&nbsp; <?php
                                                                                                                                                                                                                                    if ($level == 'kepala') {
                                                                                                                                                                                                                                      echo 'Pemimpin';
                                                                                                                                                                                                                                    } elseif ($level == 'kasi') {
                                                                                                                                                                                                                                      echo 'Pimdept';
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    ?> <?php echo $jabatan->bagian_nama; ?></span></small>
    <?php } else { ?>
