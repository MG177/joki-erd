        ...
        <div class="col-sm-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div>
                        <h3 class="card-title mb-0 font-weight-bold">Data Lembaga</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 text-left mb-2">
                                <span class="fw-bold">Pengaturan Pimpinan Lembaga</span> <br> <small>
                                    Halaman ini digunakan untuk mengedit Nama dan NP pimpinan yang sedang aktif.
                                </small>
                            </div>
                            <div class="col-sm-4 text-left">
                                <div class="form-group form-group-default">
                                    <label class="text-info fw-bold"><i class="fas fa-user-shield"></i> PEMIMPIN</label>
                                    <input required name="kepala" type="text" class="form-control fw-bold" value="<?php echo $md->nm_kepala; ?>">
                                </div>
                            </div>
                            <div class="col-sm-4 text-left">
                                <div class="form-group form-group-default">
                                    <label class="text-info fw-bold"><i class="fas fa-keyboard"></i> NP</label>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="modal-body">
                                <div class="form-group text-center">
                                    ...
                                    <?php } else { ?>
                                        <img src="<?php echo base_url(); ?>/foto/logobsg.png" alt="Foto Default" class="img-thumbnail" width="70%">
                                    <?php } ?>
