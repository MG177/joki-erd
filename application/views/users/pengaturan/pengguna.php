    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between mb-4">
          <div>
            <h3 class="card-title mb-0 font-weight-bold">Data Pengawai</h3>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      if ($baris->pegawai_level == 'staf') { ?>
                        <span class="badge badge-success fw-bold mt-1 mb-1"><i class="fas fa-id-badge"></i>&nbsp; analis</span>
                      <?php } elseif ($baris->pegawai_level == 'kasi') { ?>
                        <span class="badge badge-secondary fw-bold mt-1 mb-1"><i class="fas fa-id-badge"></i>&nbsp; pimdept</span>
                      <?php } elseif ($baris->pegawai_level == 'ktu') { ?>
                        <span class="badge badge-primary fw-bold mt-1 mb-1"><i class="fas fa-id-badge"></i>&nbsp; sekretaris</span>
                      <?php } elseif ($baris->pegawai_level == 'kepala') { ?>
                        <span class="badge badge-info fw-bold mt-1 mb-1"><i class="fas fa-id-badge"></i>&nbsp; pemimpin</span>
                      <?php } elseif ($baris->pegawai_level == 'petugas') { ?>
                        <span class="badge badge-warning fw-bold mt-1 mb-1"><i class="fas fa-id-badge"></i>&nbsp; ass. ops</span>
                      <?php } else { ?>
                        <span class="badge badge-danger fw-bold mt-1 mb-1"><i class="fas fa-id-badge"></i>&nbsp; pegawai</span>
                      <?php } ?>
                    </td>
                          ...
                          <form action="" method="post" enctype="multipart/form-data">
                            <div class="modal-body">
                              <div class="row">
                                ...
                                <div class="col-sm-12 text-left">
                                  <div class="form-group form-group-default">
                                    <label class="text-primary fw-bold">Nomor Pegawai</label>
                                    <input required name="nip" type="number" maxlength="18" class="form-control fw-bold" placeholder="Masukkan Nomor Pegawai" value="<?php echo $baris->pegawai_nip; ?>">
                                  </div>
                                </div>
                                <!-- JENIS KELAMIN -->
                                ...
                                <div class="col-sm-6 text-left">
                                  <div class="form-group form-group-default">
                                    <label class="text-primary fw-bold">LEVEL PEGAWAI</label>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-sm-12 text-left">
              <div class="form-group form-group-default">
                <label class="text-primary fw-bold">Nomor Pegawai</label>
                <input required name="nip" type="number" maxlength="18" class="form-control fw-bold" placeholder="Masukkan Nomor Pegawai">
              </div>
            </div>
            <!-- JENIS KELAMIN -->
            <div class="col-sm-12 text-left mb-4">
