...
<body>
    ...
    <?php } elseif ($sql->ska_jenis == 2) { ?>
        <table style="margin-top: -20px;">
            ...
            <tr>
                <td style="vertical-align: top;" width="7%">Yth.</td>
                <td style="vertical-align: top;" width="43%"><?php echo implode('<br>', explode(';', $sql->ska_kpd)); ?></td>
                <td style="vertical-align: top; text-align: right;" width="50%"><?php echo $md->kabupaten . ', ' . format_indo($sql->ska_tanggal); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3" style="text-align: center;">
                    <?php echo $sql->ska_hal; ?>
                </td>
            </tr>
            <tr>
                <td colspan="4" style="text-align: center;">
                    <?php echo 'Nomor : ' . $sql->ska_no_awal . '.' . $sql->ska_no_urut . $sql->ska_no_surat; ?>
                </td>
            </tr>
        </table>
        <p class="paragraf"><?php echo $sql->ska_isi; ?></p>
        <table style="margin-top: 20px;">
            ...
            <tr>
                <td width="75%" style="text-align: right;"><?php echo $md->jabatan; ?></td>
            </tr>
            <tr>
                <td colspan="2"><br><br><br><br></td>
            </tr>
            <tr>
                <td width="100%" style="text-align: right;"><?php echo $md->nm_kepala; ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2"><?php echo implode('<br>', explode(';', $sql->ska_tembusan)); ?></td>
            </tr>
        </table>
    <?php } ?>
</body>
