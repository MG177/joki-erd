                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold">
                                        ...
                                        <?php } elseif ($baris->ska_dibaca == 3) { ?>
                                            <span class="badge badge-secondary fw-bold"><i class="fas fa-tag"></i>&nbsp; Pemimpin</span>
                                        <?php } elseif ($baris->ska_dibaca == 2) { ?>
                                            <span class="badge badge-primary fw-bold"><i class="fas fa-bell"></i>&nbsp; Sekretaris</span>
                                        <?php } elseif ($baris->ska_dibaca == 1) { ?>
                                            <span class="badge badge-warning fw-bold"><i class="fas fa-spinner"></i>&nbsp; Pemimpin Departmen</span>
                                        <?php } else { ?>
