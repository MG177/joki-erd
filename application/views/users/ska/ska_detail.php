                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left fw-bold">
                                                    ...
                                                    <?php } elseif ($baris->ska_dibaca == 3) { ?>
                                                        <span class="badge badge-secondary fw-bold mt-2 mb-2"><i class="fas fa-tag"></i>&nbsp; Verifikasi Pemimpin</span>
                                                    ...
                                                    <?php } elseif ($baris->ska_dibaca == 1) { ?>
                                                        <span class="badge badge-warning fw-bold mt-2 mb-2"><i class="fas fa-spinner"></i>&nbsp; Verifikasi Pemimpin Departmen</span>
                                                    <?php } else { ?>
                            ...
                            <?php if ($baris->ska_dibaca != 1) { ?>
                                <div class="col-sm-12 text-left">
                                    <div class="alert alert-warning">
                                        ...
                                        <small>
                                            - <?php echo $baris->ska_kasi_ctt; ?> - <i class="text-info fw-bold">pimdept</i><br>
                                            - <?php echo $baris->ska_ktu_ctt; ?> - <i class="text-warning fw-bold">sekretaris</i> <br>
                                            - <?php echo $baris->ska_kepala_ctt; ?> - <i class="text-secondary fw-bold">pemimpin</i><br>
                                        </small>
                                    </div>
                                </div>
                            <?php } ?>
                                ...
                                <div class="col-sm-6 text-left mt-2">
                                    <div class="form-group form-group-default bg-dop">
                                        ...
                                        <select required name="dibaca" class="custom-select form-control fw-bold" <?php echo ($baris->ska_dibaca >= 2) ? 'disabled' : '' ?>>
                                            ...
                                            <option value="2" <?php echo ($baris->ska_dibaca == 2) ? 'selected' : '' ?>>Ajukan ke Sekretaris</option>
                                            <?php if ($baris->ska_dibaca == 3) { ?>
                                                <option value="3" <?php echo ($baris->ska_dibaca == 3) ? 'selected' : '' ?>>Ajukan ke Pemimpin</option>
