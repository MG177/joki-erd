                                        ...
                                        <tr class="fw-bold">
                                            ...
                                            <td width="70%">
                                                ...
                                                if ($query->sm_dibaca == 3) { ?>
                                                    <span class="badge badge-success fw-bold mt-2 mb-2"><i class="fas fa-check-circle"></i>&nbsp; Verifikasi Pemimpin</span>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 text-left mb-2">
                                        <span class="fw-bold">ISIAN DAN CATATAN</span> <br> <small>
                                            Lakukan disposisi departemen untuk diteruskan kepada pegawai. Berikan catatan tindakan untuk informasi tambahan.
                                        </small>
                                    </div>
                                    <!-- JABATAN SEKSI -->
                                    <div class="col-sm-6 text-left">
                                        <div class="form-group form-group-default">
                                            <label class="text-danger fw-bold"><i class="fas fa-user-tag"></i> DISPOSISI DEPARTEMEN</label>
                                            ...
                                            <select required name="jabatan" class="custom-select form-control fw-bold">
                                                <option value="">-- Pilih Disposisi Departemen --</option>
