        ...
        <div class="col-lg-12">
            <div class="card">
                                        ...
                                        <tr class="fw-bold">
                                            ...
                                            <td width="70%">
                                                ...
                                                <?php } elseif ($query->sm_dibaca == 3) { ?>
                                                    <span class="badge badge-secondary fw-bold mt-2 mb-2"><i class="fas fa-check-circle"></i>&nbsp; Verifikasi Pemimpin</span>
                                                <?php } elseif ($query->sm_dibaca == 2) { ?>
                                                    <span class="badge badge-primary fw-bold mt-2 mb-2"><i class="fas fa-bell"></i>&nbsp; Verifikasi Sekretaris</span>
                                                <?php } elseif ($query->sm_dibaca == 1) { ?>
                                                    <span class="badge badge-warning fw-bold mt-2 mb-2"><i class="fas fa-spinner"></i>&nbsp; Menunggu Sekretaris</span>
                                                <?php } else { ?>
                                        ...
                                        <table class="table table-striped table-hover" cellspacing="0" style="width: 100%;">
                                            ...
                                            <tbody class="table-bordered">
                                                ...
                                                <tr>
                                                    <td>File</td>
                                                    <td>
                                                        <!-- <a href="https://docs.google.com/viewerng/viewer?url=<?php echo base_url(); ?>lampiran/surat_masuk/<?php echo $query->nama_berkas; ?>" target="_blank" class="btn btn-xs btn-primary mb-2 mt-2 fw-bold"><i class="fas fa-eye"></i>&nbsp; Preview</a> -->
                                                ...
                                                <tr class="bg-warning">
                                                    <th colspan="2" class="text-white">Informasi Pemimpin</th>
                                                </tr>
                                                <tr>
                                                    <td>Tindakan Segera</td>
                                                    <td><?php echo implode('<br>', explode(',', $query->sm_segera)); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Tindakan Biasa</td>
                                                    <td><?php echo implode('<br>', explode(',', $query->sm_biasa)); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Catatan Pemimpin</td>
                                                ...
                                                if ($query->sm_dibaca == 4) { ?>
                                                    ...
                                                    <tr>
                                                        <td>Catatan <?php
                                                                    $data['sql'] = $this->db->query("SELECT bagian_nama FROM tbl_bagian where id_bagian ='$query->sm_bagian'")->row();
                ...
                <div class="card-footer mt--2">
                    ...
                    <a href="<?php echo base_url(); ?>users/disposisi" class="btn btn-xs btn-danger"><i class="fa fa-close"></i>&nbsp;<b>KEMBALI</b></a>
                </div>
                </form>
            <?php } ?>
            </div>
