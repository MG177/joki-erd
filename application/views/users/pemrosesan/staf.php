                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($baris->sm_dibaca == 4) { ?>
                                            ...
                                            <a href="<?php echo base_url(); ?>users/staf/cetak/<?php echo encrypt_url($baris->id_sm); ?>" class="btn btn-xs btn-warning mt-1 mb-1" target="_blank" title="Cetak"><i class="fas  fa-print"></i></a>
                                            <!-- modal detail surat -->
