                ...
                <div class="table-responsive pb-4" style="overflow-x:auto;">
                    <table id="basic-datatables" class="table table-striped table-bordered table-hover" cellspacing="0" style="width: 100%;">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($disposisi->result() as $baris) {
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php
                                        if ($baris->sm_dibaca == 4) { ?>
                                            <a href="<?php echo base_url(); ?>users/disposisi/detail/<?php echo $baris->id_sm; ?>" class="btn btn-success btn-xs mt-1 mb-1 fw-bold" title="Detail"><i class="fas fa-eye"></i></a>
                                        <?php } elseif ($baris->sm_dibaca == 3) { ?>
                                            <a href="<?php echo base_url(); ?>users/disposisi/detail/<?php echo $baris->id_sm; ?>" class="btn btn-info btn-sm mt-1 mb-1 fw-bold"><i class="fab fa-telegram-plane"></i> Periksa</a>
                                        <?php } else { ?>
                                            <span class="badge badge-danger fw-bold"><i class="fas fa-exclamation-triangle"></i>&nbsp; Proses</span>
                                        <?php } ?>
                                    </td>
