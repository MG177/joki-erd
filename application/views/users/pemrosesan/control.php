                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo date('d/m/Y', strtotime($baris->sm_tgl_diterima)); ?></td>
                                    ...
                                    <td class="text-left">
                                        <?php if ($level == 'staf') {
                                            if ($baris->sm_dibaca == 4) { ?>
                                                <span class="badge badge-success fw-bold"><i class="fas fa-check-circle"></i></span>
                                            <?php } elseif ($baris->sm_dibaca == 3) { ?>
                                                <span class="badge badge-warning fw-bold"><i class="fas fa-bell"></i></span>
                                            <?php } else { ?>
                                                <span class="badge badge-danger fw-bold"><i class="fas fa-exclamation-triangle"></i></span>
                                            <?php }
                                        } else { ?>
                                            <a href="" class="btn btn-danger btn-xs mt-1 mb-1 fw-bold" data-toggle="modal" data-target="#detailSM<?php echo $baris->id_sm; ?>"><i class="fas fa-eye"></i> Periksa</a>
                                        <?php } ?>
                                        <!-- modal detail surat -->
                                                                    ...
                                                                    <table class="table table-striped table-hover" cellspacing="0" style="width: 100%;">
                                                                        ...
                                                                        <tbody class="table-bordered">
                                                                            ...
                                                                            <?php } elseif ($baris->sm_dibaca == 3) { ?>
                                                                                ...
                                                                                <tr>
                                                                                    <td>Tindakan Biasa</td>
                                                                                    <td><?php echo implode(', ', explode(',', $baris->sm_biasa)); ?></td>
                                                                                </tr>
                                                                                <tr>
