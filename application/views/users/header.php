...
<head>
	...
	<link rel="icon" type="image/png" href="<?php echo base_url(); ?>foto/logobsg.png">
	<script>
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="red2">
				<a href="" class="logo">
					<b class="text-white"><i class="fa fa-magnet" aria-hidden="true"></i>mum </b>
				</a>
				...
				<div class="container-fluid">
					<div class="collapse" id="search-nav">
						<span class="d-flex align-items-center">
							<span class="text-white fw-bold">Selamat Datang, <?php echo ucwords($nama); ?>!</span>
						</span>
					</div>
							...
							<li class="nav-item">
								...
								<div class="collapse <?php if ($sub_menu == "pengguna" or $sub_menu == "bagian" or $sub_menu == "md") {
									...
									<ul class="nav nav-collapse pt-0">
										...
										<li><a href="<?php echo base_url(); ?>users/md"><span class="sub-item">Lembaga</span></a></li>
									</ul>
								</div>
							</li>
							<li class="nav-item">
